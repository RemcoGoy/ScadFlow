# Gotten from https://github.com/openscad/openscad-playground/blob/main/Makefile
# Pin WASM build to a version known to work
WASM_BUILD_URL=https://files.openscad.org/snapshots/OpenSCAD-2024.12.17.wasm21649-WebAssembly.zip
